...
public class TablaDispositivos {
    ...
    public TablaDispositivos() {
        ...
        DispositivoDeCatalogo ctr21 = new DispositivoDeCatalogo("Televisor - tubo fluorescente 21\"", 0.075, false, true, MetodoDeCreacion.TELEVISION);
        DispositivoDeCatalogo ctr29 = new DispositivoDeCatalogo("Televisor - tubo fluorescente 29\"", 0.175, false, true, MetodoDeCreacion.TELEVISION);
